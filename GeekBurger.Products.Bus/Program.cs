...
namespace GeekBurger.Products.Bus
{
    class Program
    {
        const string QueueConnectionString = "Endpoint=sb://geekburgernaomi.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=1/0Zjj1HVsa4sDeGGdJtWy6tadJsaEDuAH52DA/PJnc=";
